...
void MX_ADC1_Init(void)
{
  ...
  */
  hadc1.Instance = ADC1;
  hadc1.Init.ClockPrescaler = ADC_CLOCK_CK_KER_ADC12_DIV1;
...
void MX_ADC2_Init(void)
{
  ...
  */
  hadc2.Instance = ADC2;
  hadc2.Init.ClockPrescaler = ADC_CLOCK_CK_KER_ADC12_DIV1;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    PeriphClkInit.XBAR_Channel = RCC_PERIPHCLK_ADC12;
    ...
    __HAL_RCC_ADC12KERCLK_SETSOURCE(RCC_ADC12KERCLKSOURCE_CK_KER_ADC12);
