...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB14     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = PWMIn_PPS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM4;
    HAL_GPIO_Init(PWMIn_PPS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_TIM1;
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_TIM2;
    HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB14     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(PWMIn_PPS_GPIO_Port, PWMIn_PPS_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOH, GPIO_PIN_4|GPIO_PIN_3);
